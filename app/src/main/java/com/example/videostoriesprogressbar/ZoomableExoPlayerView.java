...
public class ZoomableExoPlayerView extends FrameLayout {
    ...
    public static void switchTargetView(
            ...
            @Nullable com.example.videostoriesprogressbar.ZoomableExoPlayerView oldPlayerView,
            @Nullable com.example.videostoriesprogressbar.ZoomableExoPlayerView newPlayerView) {
